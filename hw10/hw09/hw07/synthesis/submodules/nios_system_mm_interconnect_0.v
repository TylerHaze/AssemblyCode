...
module nios_system_mm_interconnect_0 (
		...
		input  wire        X_reset_reset_bridge_in_reset_reset,              //              X_reset_reset_bridge_in_reset.reset
	...
	wire  [13:0] x_s1_agent_m0_address;                                                              // X_s1_agent:m0_address -> X_s1_translator:uav_address
	...
	wire  [90:0] x_s1_agent_rf_source_data;                                                          // X_s1_agent:rf_source_data -> X_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] x_s1_agent_rsp_fifo_out_data;                                                       // X_s1_agent_rsp_fifo:out_data -> X_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> X_s1_agent:cp_valid
	wire  [89:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> X_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // X_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> X_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> X_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> X_s1_agent:cp_endofpacket
	...
	wire  [13:0] a_s1_agent_m0_address;                                                              // A_s1_agent:m0_address -> A_s1_translator:uav_address
	...
	wire  [90:0] a_s1_agent_rf_source_data;                                                          // A_s1_agent:rf_source_data -> A_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] a_s1_agent_rsp_fifo_out_data;                                                       // A_s1_agent_rsp_fifo:out_data -> A_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> A_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> A_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // A_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> A_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> A_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> A_s1_agent:cp_endofpacket
	...
	wire         x_s1_agent_rp_valid;                                                                // X_s1_agent:rp_valid -> router_007:sink_valid
	wire  [89:0] x_s1_agent_rp_data;                                                                 // X_s1_agent:rp_data -> router_007:sink_data
	wire         x_s1_agent_rp_ready;                                                                // router_007:sink_ready -> X_s1_agent:rp_ready
	wire         x_s1_agent_rp_startofpacket;                                                        // X_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         x_s1_agent_rp_endofpacket;                                                          // X_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         a_s1_agent_rp_valid;                                                                // A_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] a_s1_agent_rp_data;                                                                 // A_s1_agent:rp_data -> router_008:sink_data
	wire         a_s1_agent_rp_ready;                                                                // router_008:sink_ready -> A_s1_agent:rp_ready
	wire         a_s1_agent_rp_startofpacket;                                                        // A_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         a_s1_agent_rp_endofpacket;                                                          // A_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         x_s1_agent_rdata_fifo_src_valid;                                                    // X_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] x_s1_agent_rdata_fifo_src_data;                                                     // X_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         x_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_005:in_0_ready -> X_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> X_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> X_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // X_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> X_s1_agent:rdata_fifo_sink_error
	wire         a_s1_agent_rdata_fifo_src_valid;                                                    // A_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] a_s1_agent_rdata_fifo_src_data;                                                     // A_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         a_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_006:in_0_ready -> A_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> A_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> A_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // A_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> A_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                       //                      clk.clk
		.reset                  (X_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                         //             clk.clk
		.reset                   (X_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                       // in_clk_0.clk
		.in_rst_0_reset (X_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
